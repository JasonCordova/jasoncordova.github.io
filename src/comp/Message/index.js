...
const Message = (props) => {
    ...
    useEffect(() => {
        ...
        messageElement.current.innerHTML = `${props.message}`;

        if (props.emoji){
            messageElement.current.innerHTML += `<img alt="Wave emoji" class="emoji" src=${wave}/>`
        }
    ...
    return (
        ...
        <div className={`message clipped ${props.type === "sender" ? "sender" : ""}`}>

            <div className="message-content" ref={messageElement}></div>
